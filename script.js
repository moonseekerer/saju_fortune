...
const healthMap = {
    "甲": "담즙 분비와 신경계통을 주의해야 합니다. 활동적인 운동으로 스트레스를 해소하는 것이 좋습니다.",
    "乙": "간 기능과 손발 저림 등 말초 신경계를 잘 살펴야 합니다. 꾸준한 스트레칭이 큰 도움이 됩니다.",
    "丙": "심장과 시력 보호에 신경 써야 합니다. 혈압 관리를 위해 자극적인 음식은 피하는 것이 좋습니다.",
    "丁": "심장과 소장 계통이 예민할 수 있습니다. 충분한 수면과 명상으로 심리적 안정을 취하세요.",
    "戊": "위장 장애와 소화기 계통을 조심해야 합니다. 규칙적인 식습관 유지가 건강의 핵심입니다.",
    "己": "비장과 위장이 약해지기 쉽습니다. 배를 따뜻하게 하고 소화가 잘 되는 음식을 섭취하세요.",
    "庚": "대장과 폐 기능의 리듬을 잘 타야 합니다. 건조한 환경을 피하고 수분 섭취를 늘리세요.",
    "辛": "호흡기와 피부가 예민한 편입니다. 면역력 저하에 주의하고 기관지 관리에 신경 쓰세요.",
    "壬": "신장과 방광 등 비뇨기 계통을 주의해야 합니다. 몸이 붓지 않도록 저염식을 권장합니다.",
    "癸": "신장과 혈액 순환을 잘 관리해야 합니다. 하체를 따뜻하게 하고 가벼운 산책을 즐기세요."
};

const studyMap = {
    "甲": "목표가 생기면 무섭게 돌진하는 타입입니다. 장기적인 계획보다는 단기 목표를 달성하며 성취감을 느끼세요.",
    "乙": "창의적이고 응용 능력이 뛰어납니다. 이론 공부보다는 실제 사례나 문제를 풀며 실력을 쌓는 것이 효율적입니다.",
    "丙": "집중력이 좋지만 금방 지칠 수 있습니다. 짧고 굵게 공부하고 확실하게 휴식하는 패턴을 유지하세요.",
    "丁": "하나를 파고드는 탐구적인 공부에 재능이 있습니다. 독서나 깊이 있는 연구를 통해 전문성을 키우세요.",
    "戊": "엉덩이가 무거운 타입으로 꾸준한 학습에 강점이 있습니다. 기초를 튼튼히 다지면 결국 승리하는 대기만성형입니다.",
    "己": "기록하고 정리하는 메모력이 뛰어납니다. 자신만의 요약 노트를 만들면 학습 효율이 극대화됩니다.",
    "庚": "암기보다는 원리 이해 중심의 공부가 어울립니다. 논리적인 체계를 세워 지식을 구조화하는 연습을 하세요.",
    "辛": "섬세하고 예리하여 사소한 실수도 용납하지 않습니다. 꼼꼼한 체크를 통해 완벽함을 추구하는 공부 방식이 좋습니다.",
    "壬": "스케일이 크고 거시적인 안목이 있습니다. 넓은 범위를 훑어보고 핵심을 꿰뚫는 통합적 사고 능력이 탁월합니다.",
    "癸": "아이디어가 풍부하고 직관력이 좋습니다. 상상력을 자극하는 창의적인 분야에서 특히 뛰어난 성과를 냅니다."
};
