...
const natureMapMale = {
    "甲": "당신은 곧게 뻗은 대림목(큰 나무)과 같습니다. 듬직한 리더십과 강한 자존심을 지닌 상남자 스타일입니다.",
    "乙": "유연한 생명력을 지녔습니다. 겉은 부드럽지만 안으로는 누구보다 끈질긴 집념을 가진 외유내강형입니다.",
    "丙": "하늘의 태양처럼 열정적입니다. 솔직담백하고 정의로운 성격으로 주변을 밝히는 에너지가 넘칩니다.",
    "丁": "섬세하고 집중력이 뛰어난 장인 정신을 가졌습니다. 따뜻한 마음으로 주변을 챙기는 젠틀맨입니다.",
    "戊": "거대한 산처럼 진중합니다. 믿음직스럽고 무게감 있는 존재로 주변 사람들이 의지하고 싶어 하는 사람입니다.",
    "己": "비옥한 논밭처럼 다재다능합니다. 꼼꼼하고 실속을 잘 챙기며 사회생활에 능통한 지혜를 가졌습니다.",
    "庚": "강력한 단단한 무쇠와 같습니다. 결단력이 뛰어나고 의리가 넘치는 자수성가형 인재입니다.",
    "辛": "완벽을 추구하는 세련된 귀공자 스타일입니다. 예리한 통찰력과 깔끔한 일처리로 어디서든 빛이 납니다.",
    "壬": "넓고 깊은 바다처럼 영리합니다. 스케일이 크고 야망이 있으며 임기응변에 뛰어난 지략가입니다.",
    "癸": "맑은 시냇물처럼 순수하고 영리합니다. 상상력이 풍부하며 주변을 기분 좋게 만드는 지혜가 있습니다."
};

const natureMapFemale = {
    "甲": "곧게 뻗은 나무처럼 당당한 매력을 가진 커리어우먼 스타일입니다. 자존심이 높고 주관이 뚜렷합니다.",
    "乙": "아름답고 유연한 꽃과 같습니다. 환경 적응력이 뛰어나고 사람들의 마음을 사로잡는 매력이 있습니다.",
    "丙": "열정적인 태양처럼 당당합니다. 화려한 존재감을 뽐내며 어디서나 분위기를 주도하는 여왕 같은 기질이 있습니다.",
    "丁": "밤하늘의 달빛처럼 우아하고 섬세합니다. 배려심이 깊고 사람을 따뜻하게 안아주는 자애로움을 가졌습니다.",
    "戊": "듬직하고 포용력 넓은 산과 같습니다. 흔들림 없는 평온함과 넓은 마음으로 주변을 감싸는 힘이 있습니다.",
    "己": "풍요로운 대지처럼 포용력이 좋습니다. 알뜰살뜰하게 실속과 사람을 모두 챙기는 실천적인 리더입니다.",
    "庚": "의리 있고 결단력 있는 여장부 스타일입니다. 시원시원한 성격으로 복잡한 일을 단번에 해결하는 능력이 있습니다.",
    "辛": "반짝이는 보석처럼 섬세하고 완벽을 추구합니다. 고결한 분위기를 자아내며 미적 감각이 매우 뛰어납니다.",
    "壬": "깊은 호수처럼 신비롭고 지혜롭습니다. 통찰력이 뛰어나며 자유분방한 사고로 세상을 바라봅니다.",
    "癸": "촉촉한 봄비처럼 다정다감합니다. 사람들의 마음을 어루만지는 공감 능력이 탁월하고 영리합니다."
};
